...
//Deliverable 3: Create a third map layer.
...
//Variable "overlays" is a reference to each of the layer group
let overlays = {
...
// Dropdown menu which allows users to select which layers are visible on the map.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
  ...
  //Color function here only uses three colors for the major earthquakes based on the magnitude of the earthquake.
  function getColor(magnitude) {
    if (magnitude > 6) {
      return "#800080";
    }
